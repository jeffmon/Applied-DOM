(function(window) {
   ...
   */
   ...
   btn4.addEventListener("click", function(event){
    setMyLightClass.apply(btn4, ["click", "light-green"]);
   });
   ...
   */
   ...
   btn5.addEventListener("click", (event) => {
    setMyLightClass.apply(btn5, ["click", "light-green"])
   });
   ...
   */
   ...
   btn8.addEventListener("click", function(event){
    setMyLightClass.call(btn8, "click", "light-green");
   });
   ...
   */
   ...
   btn9.addEventListener("click", (event) => {
    setMyLightClass.call(btn9, "click", "light-green");
   });
   ...
   */
   ...
   btn12.addEventListener("click", function(event){
    setLight12Class("click", "light-green");
   });
